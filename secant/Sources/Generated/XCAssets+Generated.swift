...
public enum Asset {
  public enum Assets {
    ...
    public enum Assets {
      public static let wif = ImageAsset(name: "$wif")
      public static let aave = ImageAsset(name: "aave")
      public static let abg = ImageAsset(name: "abg")
      public static let ada = ImageAsset(name: "ada")
      public static let adi = ImageAsset(name: "adi")
      public static let aleo = ImageAsset(name: "aleo")
      public static let apt = ImageAsset(name: "apt")
      public static let arb = ImageAsset(name: "arb")
      public static let aster = ImageAsset(name: "aster")
      public static let aurora = ImageAsset(name: "aurora")
      public static let avax = ImageAsset(name: "avax")
      public static let bch = ImageAsset(name: "bch")
      public static let bera = ImageAsset(name: "bera")
      public static let blackdragon = ImageAsset(name: "blackdragon")
      public static let bnb = ImageAsset(name: "bnb")
      public static let bome = ImageAsset(name: "bome")
      public static let brett = ImageAsset(name: "brett")
      public static let brrr = ImageAsset(name: "brrr")
      public static let btcOmni = ImageAsset(name: "btc(omni)")
      public static let btc = ImageAsset(name: "btc")
      public static let cbbtc = ImageAsset(name: "cbbtc")
      public static let cfi = ImageAsset(name: "cfi")
      public static let cow = ImageAsset(name: "cow")
      public static let dai = ImageAsset(name: "dai")
      ...
      public static let eure = ImageAsset(name: "eure")
      public static let evaa = ImageAsset(name: "evaa")
      public static let fms = ImageAsset(name: "fms")
      public static let frax = ImageAsset(name: "frax")
      public static let gbpe = ImageAsset(name: "gbpe")
      ...
      public static let jambo = ImageAsset(name: "jambo")
      public static let kaito = ImageAsset(name: "kaito")
      public static let knc = ImageAsset(name: "knc")
      public static let link = ImageAsset(name: "link")
      public static let loud = ImageAsset(name: "loud")
      public static let ltc = ImageAsset(name: "ltc")
      public static let melania = ImageAsset(name: "melania")
      public static let mog = ImageAsset(name: "mog")
      public static let mon = ImageAsset(name: "mon")
      public static let mpdao = ImageAsset(name: "mpdao")
      public static let near = ImageAsset(name: "near")
      public static let nearkat = ImageAsset(name: "nearkat")
      public static let noear = ImageAsset(name: "noear")
      public static let npro = ImageAsset(name: "npro")
      public static let okb = ImageAsset(name: "okb")
      public static let op = ImageAsset(name: "op")
      public static let pengu = ImageAsset(name: "pengu")
      public static let pepe = ImageAsset(name: "pepe")
      public static let pol = ImageAsset(name: "pol")
      public static let `public` = ImageAsset(name: "public")
      public static let purge = ImageAsset(name: "purge")
      public static let ref = ImageAsset(name: "ref")
      public static let rhea = ImageAsset(name: "rhea")
      public static let safe = ImageAsset(name: "safe")
      public static let shib = ImageAsset(name: "shib")
      public static let shitzu = ImageAsset(name: "shitzu")
      public static let sol = ImageAsset(name: "sol")
      public static let spx = ImageAsset(name: "spx")
      public static let stjack = ImageAsset(name: "stjack")
      public static let strk = ImageAsset(name: "strk")
      public static let sui = ImageAsset(name: "sui")
      public static let susdc = ImageAsset(name: "susdc")
      public static let sweat = ImageAsset(name: "sweat")
      public static let titn = ImageAsset(name: "titn")
      public static let ton = ImageAsset(name: "ton")
      public static let trump = ImageAsset(name: "trump")
      public static let trx = ImageAsset(name: "trx")
      public static let turbo = ImageAsset(name: "turbo")
      public static let uni = ImageAsset(name: "uni")
      public static let usad = ImageAsset(name: "usad")
      public static let usd1 = ImageAsset(name: "usd1")
      public static let usdc = ImageAsset(name: "usdc")
      public static let usdcx = ImageAsset(name: "usdcx")
      public static let usdf = ImageAsset(name: "usdf")
      public static let usdt = ImageAsset(name: "usdt")
      public static let wbtc = ImageAsset(name: "wbtc")
      public static let weth = ImageAsset(name: "weth")
      public static let wnear = ImageAsset(name: "wnear")
      public static let xbtc = ImageAsset(name: "xbtc")
      public static let xdai = ImageAsset(name: "xdai")
      public static let xlm = ImageAsset(name: "xlm")
      public static let xpl = ImageAsset(name: "xpl")
      public static let xrp = ImageAsset(name: "xrp")
      public static let zec = ImageAsset(name: "zec")
    }
    ...
    public enum Chains {
      public static let chainAdi = ImageAsset(name: "chain_adi")
      public static let chainAleo = ImageAsset(name: "chain_aleo")
      public static let chainAptos = ImageAsset(name: "chain_aptos")
      public static let chainArb = ImageAsset(name: "chain_arb")
      public static let chainAster = ImageAsset(name: "chain_aster")
      public static let chainAvax = ImageAsset(name: "chain_avax")
      public static let chainBase = ImageAsset(name: "chain_base")
      public static let chainBch = ImageAsset(name: "chain_bch")
      public static let chainBera = ImageAsset(name: "chain_bera")
      public static let chainBsc = ImageAsset(name: "chain_bsc")
      public static let chainBtc = ImageAsset(name: "chain_btc")
      public static let chainCardano = ImageAsset(name: "chain_cardano")
      public static let chainDash = ImageAsset(name: "chain_dash")
      public static let chainDoge = ImageAsset(name: "chain_doge")
      public static let chainEth = ImageAsset(name: "chain_eth")
      public static let chainGnosis = ImageAsset(name: "chain_gnosis")
      public static let chainLtc = ImageAsset(name: "chain_ltc")
      public static let chainMonad = ImageAsset(name: "chain_monad")
      public static let chainNear = ImageAsset(name: "chain_near")
      public static let chainOp = ImageAsset(name: "chain_op")
      public static let chainPlasma = ImageAsset(name: "chain_plasma")
      public static let chainPol = ImageAsset(name: "chain_pol")
      public static let chainSol = ImageAsset(name: "chain_sol")
      public static let chainStarknet = ImageAsset(name: "chain_starknet")
      public static let chainStellar = ImageAsset(name: "chain_stellar")
      public static let chainSui = ImageAsset(name: "chain_sui")
      public static let chainTon = ImageAsset(name: "chain_ton")
      public static let chainTron = ImageAsset(name: "chain_tron")
      public static let chainXlayer = ImageAsset(name: "chain_xlayer")
      public static let chainXrp = ImageAsset(name: "chain_xrp")
      public static let chainZec = ImageAsset(name: "chain_zec")
    }
    ...
    public static let ksqrDynamicOverlay = ImageAsset(name: "KS_QRDynamicOverlay")
    public static let ksqrOverlay = ImageAsset(name: "KS_QROverlay")
    public enum Partners {
      ...
      public static let coinbaseDisabled = ImageAsset(name: "coinbaseDisabled")
    ...
    public static let qrDynamicOverlayLow = ImageAsset(name: "QRDynamicOverlayLow")
    public static let qrDynamicOverlayMax = ImageAsset(name: "QRDynamicOverlayMax")
    public static let qrOverlayLow = ImageAsset(name: "QROverlayLow")
    public static let qrOverlayMax = ImageAsset(name: "QROverlayMax")
    public static let splashHi = ImageAsset(name: "SplashHi")
    public enum Tickers {
      public static let near = ImageAsset(name: "near")
      public static let nearChain = ImageAsset(name: "nearChain")
    ...
    public enum Icons {
      ...
      public static let crypto = ImageAsset(name: "crypto")
  ...
  public enum Colors {
    ...
    public static let launchScreenBcg = ColorAsset(name: "launchScreenBcg")
