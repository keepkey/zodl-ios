...
struct UserPreferencesStorageClient {
    ...
    var selectedServers: @Sendable () -> UserPreferencesStorage.SelectedServersConfig? = { nil }
    var setSelectedServers: @Sendable (UserPreferencesStorage.SelectedServersConfig) throws -> Void
